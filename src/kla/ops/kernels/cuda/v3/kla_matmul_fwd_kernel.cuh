/******************************************************************************
 * KLA v3 forward: trace-normalized Möbius scan + affine information scan.
 * Grid (batch, channel); threads own contiguous timesteps; serial state loop.
 * Saves matrix, eta and lambda chunk checkpoints, no [B,L,M,S] trajectory.
 * Synchronize between cooperative operations sharing CUB temporary storage.
 ******************************************************************************/
#pragma once
